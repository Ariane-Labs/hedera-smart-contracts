...
Currently, Hedera’s system contracts are stored in the repository [Ariane-Labs/hedera-smart-contracts](https://github.com/Ariane-Labs/hedera-smart-contracts).
...
| `contracts/system-contracts/hedera-token-service/IHederaTokenService.sol` | `contracts/token-service/IHederaTokenService.sol`    |
| `contracts/system-contracts/hedera-token-service/IHRC719.sol`             | `contracts/token-service/IHRC719.sol`                |
...
- A high-level description of the contract’s purpose and role within the Hedera ecosystem.
